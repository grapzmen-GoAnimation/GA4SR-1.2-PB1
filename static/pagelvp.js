				...
				<div class="col-sm-6 video-left">
					<div class="status-container">
						<div class="vthumb-container">
							<div class="vthumb">
								<div class="vthumb-clip"><div class="vthumb-clip-inner"><span class="valign"></span><img src="https://web.archive.org/web/20151107025248im_/http://s3.amazonaws.com/fs.goanimate.com/files/thumbnails/movie/600/4926600/16647503.jpg" alt="Don't like dogs"></div></div>
							</div>
						</div>
					</div>
					<div class="video-top-content clearfix">
						<div class="pull-left video-info">
							<h1>Don't like dogs</h1>
			...
			<div class="col-md-8">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="video-info">
						<p class="inside">Published on: 11 Jun 2013</p>
						<p></p>
					</div>
				</div>
			</div>
